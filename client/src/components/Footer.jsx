...
const Footer = () => {
    ...
    const handleSubscribe = async (e) => {
        e.preventDefault();
        try {
          const response = await axios.post(`${import.meta.env.VITE_APP_BACKEND_URL}/subscriber`, { email });
...
<footer className="footer p-10 bg-base-200 text-base-content">
  <aside>
    <h2 className='text-4xl '>DigiStore</h2>
    <p>Providing reliable digital wellness since 2024</p>
  </aside> 
  <nav>
  ...
  <nav>
    ...
    <a className="link link-hover">digistore@work.com</a>
